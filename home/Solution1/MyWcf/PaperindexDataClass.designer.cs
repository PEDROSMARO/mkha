...
namespace MyWcf
{
    ...
    partial void Deletejournal(journal instance);
		...
		public PaperindexDataClassDataContext() : 
				base(global::MyWcf.Properties.Settings.Default.papersindexConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Paper : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _Yearofpub;
    ...
    partial void OnYearofpubChanging(System.Nullable<System.DateTime> value);
    ...
    partial void OnKeywordsChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Yearofpub", DbType="Date")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=6)]
		public System.Nullable<System.DateTime> Yearofpub
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Paper_journal", Storage="_journals", ThisKey="jouTitle", OtherKey="journalTitle")]
		...
		public EntitySet<journal> journals
		{
			...
			{
				if ((this.serializing 
							&& (this._journals.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnjouclassChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Paper_journal", Storage="_Paper", ThisKey="journalTitle", OtherKey="jouTitle", IsForeignKey=true)]
		public Paper Paper
		{
			get
			{
			...
			set
			{
							...
							|| (this._Paper.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._journalTitle = value.jouTitle;
					}
					else
					{
						this._journalTitle = default(string);
					}
